...
- [x] Seed: 28 рецептов с фото-заглушками PIL, 64 ингредиента, готовый план меню для alice, 2 пользователя (alice/bob), 22 комментария, 15 рейтингов, 10 избранных (Phase 8)
